Attribute VB_Name = "EvtCtx_Standalone"
Option Explicit

' Self-contained user-mode ETW silencer for Word/Excel/Access (64-bit Office).
' Paste into a standard module. No dependencies.
'
